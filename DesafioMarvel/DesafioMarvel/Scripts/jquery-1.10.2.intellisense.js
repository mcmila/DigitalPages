...
intellisense.annotate(jQuery.fn, {
  ...
  'multiple': function() {
    /// <signature>
    ///   <summary>Selects the combined Characters of all the specified selectors.</summary>
  ...
  'undelegate': function() {
    ...
    ///   <param name="selector" type="String">A selector which will be used to filter the event Characters.</param>
    ///   <param name="eventType" type="String">A string containing a JavaScript event type, such as "click" or "keydown"</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
